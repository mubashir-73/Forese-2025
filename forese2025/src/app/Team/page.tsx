...
import { coreMembers, members, seniorMembers, type CoreMember } from "../../data/team";
import ProfileCard from "../../components/ui/ProfileCard";

type TabKey = "core" | "senior" | "members";

// CoreMember type is imported from data file
...
function CoreMemberCard({ member }: { member: CoreMember }) {
...
export default function Team() {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col px-4 md:px-8">
      <div className="pt-16 pb-8 justify-center flex w-full">
        <h1 className="text-4xl md:text-5xl text-white font-bold tracking-tight">Our Team</h1>
      </div>
